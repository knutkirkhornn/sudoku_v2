...
public class MainActivity extends AppCompatActivity {
    ...
    public void onRussianFlagClick(View view) {
        if (currentEnglish) {
            Log.i(TAG, "Russian is now selected");
            SharedPreferences sharedPreferences = getDefaultSharedPreferences(this);
            SharedPreferences.Editor editor = sharedPreferences.edit();
            Resources resources = getBaseContext().getResources();
            Configuration configuration = new Configuration();
            ...
            Toast.makeText(this, "Русский язык", Toast.LENGTH_SHORT).show();
        } else {
            Log.i(TAG, "Russian is already selected");
            Toast.makeText(this, "Русский уже выбран", Toast.LENGTH_SHORT).show();
        }
    }
